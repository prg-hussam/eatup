...
const options = {
    ...
    columns: [
        {
            name: "name",
            label: "admin.categories.table.name",
        },
        {
            name: "status",
...
<template>
    <Head :title="$t('admin.categories.categories')" />
    <DashboardLayout>
        <template #breadcrumb>
            <Breadcrumb :title="$t('admin.categories.categories')">
                <BreadcrumbItem
                    active
                ...
                :bulkActions="[
                    {
                        ...
                        label: $t(`resource.delete_selected`, {
                            resource: $t('admin.categories.categories'),
                        }),
                    },
                ]"
                :actions="[
                    {
                        ...
                        label: $t(`resource.edit`, {
                            resource: $t('admin.categories.category'),
                        }),
                    },
                    {
                        key: 'destroy',
