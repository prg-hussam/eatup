...
import CrudForm from "./Partials/CrudForm.vue";
...
<template>
    <Head
        :title="$t('resource.edit', { resource: $t('admin.sliders.slider') })"
    />
    <DashboardLayout>
        <template #breadcrumb>
            <Breadcrumb
        ...
        <template #content>
            <CrudForm :tabs="tabs" :slider="slider" action="update" />
        </template>
    </DashboardLayout>
</template>
